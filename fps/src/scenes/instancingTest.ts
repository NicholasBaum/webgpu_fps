...
export class InstancingTest extends Scene {
    constructor() {
        ...
        this.models.push(createSphere2("blinn", blinn).translate(2, 0, 0));
        this.models.push(createSphere2("blinn", blinn).translate(4, 0, 0));

        let blinnNormal = new BlinnPhongMaterial({ diffuseColor: [0, 1, 0, 1], normalMapPath: `../${BASEPATH}/assets/spiral_normal.png`, });
        this.models.push(createSphere2("blinn", blinnNormal).translate(2, 2, 0));
        this.models.push(createSphere2("blinn", blinnNormal).translate(4, 2, 0));

        //blinn = new BlinnPhongMaterial({ diffuseColor: [0, 1, 1, 1] });
        this.models.push(createSphere2("blinn", blinn, false).translate(2, 0, 2));
        this.models.push(createSphere2("blinn", blinn, false).translate(4, 0, 2));

        //blinnNormal = new BlinnPhongMaterial({ diffuseColor: [1, 0, 0, 1], normalMapPath: `../${BASEPATH}/assets/spiral_normal.png`, });
        this.models.push(createSphere2("blinn", blinnNormal, false).translate(2, 2, 2));
        this.models.push(createSphere2("blinn", blinnNormal, false).translate(4, 2, 2));




        let pbr = new PbrMaterial({ albedo: [0, 0, 1, 1] });
        this.models.push(createSphere2("pbr", pbr).translate(-2, 0, 0));
        this.models.push(createSphere2("pbr", pbr).translate(-4, 0, 0));

        let pbrNormal = new PbrMaterial({ albedo: [0, 1, 0, 1], normalMapPath: `../${BASEPATH}/assets/spiral_normal.png`, });
        this.models.push(createSphere2("pbr", pbrNormal).translate(-2, -2, 0));
        this.models.push(createSphere2("pbr", pbrNormal).translate(-4, -2, 0));

        //pbr = new PbrMaterial({ albedo: [0, 1, 1, 1] });
        this.models.push(createSphere2("pbr", pbr, false).translate(-2, 0, -2));
        this.models.push(createSphere2("blinn", pbr, false).translate(-4, 0, -2));

        //pbrNormal = new PbrMaterial({ albedo: [1, 0, 0, 1], normalMapPath: `../${BASEPATH}/assets/spiral_normal.png`, });
        this.models.push(createSphere2("pbr", pbrNormal, false).translate(-2, -2, -2));
        this.models.push(createSphere2("pbr", pbrNormal, false).translate(-4, -2, -2));
    }
}